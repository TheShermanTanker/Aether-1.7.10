package com.gildedgames.aether.world.dungeon;
...
import com.gildedgames.aether.world.dungeon.util.AetherDungeon;
import com.gildedgames.aether.world.dungeon.util.PositionData;
import com.gildedgames.aether.world.util.RandomTracker;
...
public class BronzeDungeon extends AetherDungeon {
	...
	public boolean generateNextRoom(World world, Random random, PositionData pos, int dir) {
		...
		switch (type) {
			case 0: {
				world.setBlock(p, y + 2, q, BlocksAether.chestMimic);
				break;
			}
			case 1: {
	...
	private ItemStack getNormalLoot(Random random) {
		...
		switch (item) {
			...
			case 1:
				return new ItemStack(ItemsAether.zaniteAxe);
			case 2:
				return new ItemStack(ItemsAether.zaniteSword);
			case 3:
				return new ItemStack(ItemsAether.zaniteShovel);
			case 4:
				return new ItemStack(ItemsAether.swetCape);
			case 5:
			...
			case 12: {
				if (random.nextInt(4) == 0) {
					return new ItemStack(ItemsAether.ironRing);
				}
				break;
			}
			case 13: {
				if (random.nextInt(10) == 0) {
					return new ItemStack(ItemsAether.goldenRing);
				}
				break;
			}
		}
	...
	public static ItemStack getBronzeLoot(Random random) {
		...
		switch (item) {
			case 0:
				return new ItemStack(ItemsAether.gummySwet, random.nextInt(7) + 1, random.nextInt(2));
			case 1:
				return new ItemStack(ItemsAether.phoenixBow);
			case 2:
				return new ItemStack(ItemsAether.flamingSword);
			case 3:
				return new ItemStack(ItemsAether.notchHammer);
			case 4:
				return new ItemStack(ItemsAether.lightningKnife, random.nextInt(20) + 1);
			case 5:
				return new ItemStack(ItemsAether.valkyrieLance);
			case 6:
				return new ItemStack(ItemsAether.agilityCape);
			case 7:
				return new ItemStack(ItemsAether.sentryBoots);
			case 8:
				return new ItemStack(ItemsAether.repulsionShield);
		}

		return new ItemStack(ItemsAether.cloudStaff);
	}
