...
public class ComponentGoldenDungeon extends AetherStructure {
	...
	public static ItemStack getGoldLoot(Random random) {
		...
		switch (item) {
			case 0:
				return new ItemStack(ItemsAether.ironBubble);
			case 1:
				return new ItemStack(ItemsAether.vampireBlade);
			case 2:
				return new ItemStack(ItemsAether.pigSlayer);
			case 3: {
				if (random.nextBoolean()) {
					return new ItemStack(ItemsAether.phoenixHelmet);
				}

				if (random.nextBoolean()) {
					return new ItemStack(ItemsAether.phoenixLeggings);
				}
			...
			case 6: {
				if (random.nextBoolean()) {
					return new ItemStack(ItemsAether.gravititeHelmet);
				}

				if (random.nextBoolean()) {
					return new ItemStack(ItemsAether.gravititeLeggings);
				}
		...
		return new ItemStack(ItemsAether.obsidianChestplate);
	}
