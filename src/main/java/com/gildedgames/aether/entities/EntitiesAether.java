package com.gildedgames.aether.entities;
...
import com.gildedgames.aether.entities.effects.PotionInebriation;
...
import com.gildedgames.aether.entities.projectile.darts.EntityDartEnchanted;
import com.gildedgames.aether.entities.projectile.darts.EntityDartGolden;
...
import com.gildedgames.aether.entities.util.EntityAetherItem;
...
public class EntitiesAether {
	...
	public static void register(Class<? extends Entity> entityClass, String entityName, int entityID, int trackingRange, int updateFrequency, boolean sendsVelocityUpdates) {
		EntityRegistry.registerModEntity(entityClass, entityName, entityID, Aether.aether, trackingRange, updateFrequency, sendsVelocityUpdates);
	}
	...
	public static void register(Class<? extends Entity> entityClass, String entityName, int entityID, int primaryEggColor, int secondaryEggColor) {
		...
		EntityRegistry.registerModEntity(entityClass, entityName, entityID, Aether.aether, 80, 3, true);
	}
