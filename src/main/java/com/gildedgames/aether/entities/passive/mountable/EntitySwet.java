package com.gildedgames.aether.entities.passive.mountable;

import com.gildedgames.aether.AetherConfig;
import com.gildedgames.aether.api.AetherAPI;
import com.gildedgames.aether.api.player.IPlayerAether;
import com.gildedgames.aether.blocks.BlocksAether;
import com.gildedgames.aether.entities.hostile.swet.EnumSwetType;
import com.gildedgames.aether.entities.util.EntityMountable;
import com.gildedgames.aether.items.ItemsAether;
import com.gildedgames.aether.network.AetherNetwork;
import com.gildedgames.aether.network.packets.PacketSwetJump;
...
public class EntitySwet extends EntityMountable
{
    ...
    public boolean isPlayerFriendly(EntityPlayer player)
    {
        ...
        return iPlayerAether.getAccessoryInventory().wearingAccessory(new ItemStack(ItemsAether.swetCape));
    }
    ...
    protected void dropFewItems(boolean recentlyHit, int lootLevel)
    {
        ...
        else
        {
            ...
            this.entityDropItem(new ItemStack(ItemsAether.swetBall, count), 1.0F);
        }
    }
