...
import com.gildedgames.aether.entities.util.EntitySaddleMount;
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (stack != null && this.isPlayerGrown() && !this.worldObj.isRemote) {
            ...
            if (this.isChild() && this.isHungry()) {
                if (this.getAmountFed() < 3 && currentItem == ItemsAether.aechorPetal) {
            ...
            if (currentItem == ItemsAether.natureStaff) {
