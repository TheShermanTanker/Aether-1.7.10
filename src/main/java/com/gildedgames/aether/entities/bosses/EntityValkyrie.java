package com.gildedgames.aether.entities.bosses;
...
import com.gildedgames.aether.entities.hostile.EntityAetherMob;
...
public class EntityValkyrie extends EntityAetherMob {
	...
	public boolean interact(EntityPlayer entityplayer) {
		...
		if (stack != null && stack.getItem() == ItemsAether.victoryMedal && stack.stackSize >= 0) {
	...
	protected void dropFewItems(boolean var1, int var2) {
		dropItem(ItemsAether.victoryMedal, 1);
	}
