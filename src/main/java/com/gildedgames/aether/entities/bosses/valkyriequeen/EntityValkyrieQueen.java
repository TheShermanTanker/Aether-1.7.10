package com.gildedgames.aether.entities.bosses.valkyriequeen;
...
import com.gildedgames.aether.entities.util.AetherNameGen;
import com.gildedgames.aether.entities.util.EntityAetherItem;
import com.gildedgames.aether.entities.util.EntityBossMob;
...
public class EntityValkyrieQueen extends EntityBossMob implements IAetherBoss {
    ...
    protected void dropFewItems(boolean var1, int var2) {
        this.entityDropItem(new ItemStack(ItemsAether.dungeonKey, 1, 1), 0.5F);
    ...
    public int getMedals(EntityPlayer entityplayer) {
        ...
        for (ItemStack item : entityplayer.inventory.mainInventory) {
            if (item != null) {
                if (item.getItem() == ItemsAether.victoryMedal) {
