package com.gildedgames.aether.client.overlay;
...
public class AetherOverlay {
	...
	public static void renderIronBubble(Minecraft mc) {
		...
		int bubbleAmount = PlayerAether.get(mc.thePlayer).getAccessoryInventory().getAccessoryCount(new ItemStack(ItemsAether.ironBubble));
