...
import com.gildedgames.aether.client.models.attachments.ModelAetherWings;
import com.gildedgames.aether.client.models.attachments.ModelHalo;
...
public class PlayerAetherRenderer {
    ...
    private void renderModel(PlayerAether playerAether, float limbSwing, float prevLimbSwing, float rotation, float interpolateRotation, float prevRotationPitch, float scale, float partialTicks) {
        ...
        if (playerAether.getAccessoryInventory().getStackInSlot(AccessoryType.CAPE) != null && !playerAether.getAccessoryInventory().wearingAccessory(new ItemStack(ItemsAether.invisibilityCape))) {
