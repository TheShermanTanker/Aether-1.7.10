...
public class ItemAetherArmor extends ItemArmor {
	...
	private String[] defaultLocation = new String[]{"textures/models/armor/iron_layer_1.png", "textures/models/armor/iron_layer_2.png"};
	...
	public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
		...
		return this.shouldDefualt ? (leggings ? defaultLocation[1] : defaultLocation[0]) : Aether.modAddress() + "textures/armor/" + this.armorName + "_" + type1 + ".png";
	}
	...
	public EnumRarity getRarity(ItemStack stack) {
		return !this.armorName.contains("zanite") && !this.armorName.contains("gravitite") ? ItemsAether.aetherLoot : super.getRarity(stack);
	}
}