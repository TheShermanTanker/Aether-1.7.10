package com.gildedgames.aether.items.accessories;
...
public class ItemAccessory extends Item {
	...
	{
		return (repair.getItem() == ItemsAether.zaniteGemstone && toRepair.getItem() == ItemsAether.zaniteRing)
				|| (repair.getItem() == ItemsAether.zaniteGemstone && toRepair.getItem() == ItemsAether.zanitePendant);
	}
	...
	public EnumRarity getRarity(ItemStack stack) {
		return this.isDungeonLoot ? ItemsAether.aetherLoot : super.getRarity(stack);
	}
