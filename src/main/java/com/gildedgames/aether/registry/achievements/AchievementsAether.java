package com.gildedgames.aether.registry.achievements;
...
public class AchievementsAether {
	...
	public static void initialization() {
		...
		defeat_bronze = new AetherAchievement("advancement.aether_legacy.bronze_dungeon", "bronze_dungeon", -2, 3, new ItemStack(ItemsAether.dungeonKey, 1, 0), enter_aether).registerStat();
		defeat_silver = new AetherAchievement("advancement.aether_legacy.silver_dungeon", "silver_dungeon", 0, 4, new ItemStack(ItemsAether.dungeonKey, 1, 1), enter_aether).registerStat();
		defeat_gold = new AetherAchievement("advancement.aether_legacy.gold_dungeon", "gold_dungeon", 2, 3, new ItemStack(ItemsAether.dungeonKey, 1, 2), enter_aether).registerStat();
		...
		grav_tools = new AetherAchievement("advancement.aether_legacy.gravitite_tools", "gravitite_tools", -1, -3, ItemsAether.gravititePickaxe, enter_aether).registerStat();
		loreception = new AetherAchievement("advancement.aether_legacy.loreception", "loreception", 1, -3, ItemsAether.loreBook, enter_aether).registerStat();
