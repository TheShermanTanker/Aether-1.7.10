...
public class BlocksAether {
	...
	public static Block chestMimic, treasureChest;
	...
	public static void initialization() {
		...
		treasureChest = register("treasure_chest", new BlockTreasureChest());
		...
		aerogel_wall = registerRarity("aerogel_wall", new BlockAetherWall(aerogel), ItemsAether.aetherLoot);
		...
		aerogel_stairs = registerRarity("aerogel_stairs", new BlockAetherStairs(aerogel), ItemsAether.aetherLoot);
